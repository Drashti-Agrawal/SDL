    ...
    for key, value in subjects.items():
       ...
       # print(data)
        ...
        table.setStyle(TableStyle([
            ...
            ('FONTSIZE', (0, 0), (-1, -1), 6),                # Set font size to 8
            ...
            ('BOX', (0, 0), (-1, -1), 2, colors.black),       # Border around the table
        ]))
...
# Specify the row number you want to check, here using row 1 as an example
    row_number = 0
    sub = ''
# Loop through the columns starting from index 3 to the length of the row
